        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-gray-800 rounded-3xl shadow-2xl p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <div className="bg-linear-to-br from-blue-600 to-blue-800 p-10 rounded-3xl text-center text-white">
                <div className="text-6xl font-bold">87</div>
                <p className="text-2xl mt-3">منتج في المخزون</p>
              </div>
              <div className="bg-linear-to-br from-green-600 to-green-800 p-10 rounded-3xl text-center text-white">
                <div className="text-6xl font-bold">342</div>
                <p className="text-2xl mt-3">طلب مكتمل</p>
              </div>
              <div className="bg-linear-to-br from-yellow-500 to-orange-600 p-10 rounded-3xl text-center text-white">
