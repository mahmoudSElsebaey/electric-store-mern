...
export default function Contact() {
  ...
  return (
    <>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gray-50" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="space-y-10 sm:space-y-12 order-2 lg:order-1">
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 lg:p-10">
                ...
                <div className="space-y-6 sm:space-y-8 text-base sm:text-lg">
                  ...
                  <div className="flex items-start gap-4 sm:gap-6">
                    <div className="bg-amber-100 p-3 sm:p-4 rounded-full shrink-0">
                      <FaClock className="w-6 h-6 sm:w-8 sm:h-8 text-amber-600" />
                    </div>
                    <div>
                      <p className="font-bold text-lg sm:text-xl">
                ...
                <div className="mt-10 sm:mt-12">
                  ...
                  <div className="flex flex-wrap gap-4 sm:gap-6">
                    ...
                    <a href="#" className="bg-red-600 p-3 sm:p-4 rounded-full text-white hover:bg-red-700 hover:-translate-y-1 transition shadow-md" target="_blank" rel="noopener noreferrer">
